...
class interview_comment2(models.Model):
    _name = 'interview.comment2'
    ...
    def unlink(self):
        ...
        return super(interview_comment2, self).unlink()
    ...
    def write(self,vals):
        ...
        return super(interview_comment2, self).write(vals)
