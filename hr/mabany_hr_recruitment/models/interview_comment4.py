...
class interview_comment4(models.Model):
    _name = 'interview.comment4'
    ...
    def unlink(self):
        ...
        return super(interview_comment4, self).unlink()
    ...
    def write(self,vals):
        ...
        return super(interview_comment4, self).write(vals)
