...
class ResourceCalendar(models.Model):
    ...
    missing_penalty_type = fields.Selection([('fixed', 'Fixed'), ('cumulative', 'Cumulative')], default='fixed')
    missing_penalty_fixed_rate = fields.Float(default=1)
    missing_penalty_line_ids = fields.One2many('missing.penalty.line', 'resource_calendar_id')
