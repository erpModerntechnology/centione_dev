...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        default_end_service_incentive = self.env["ir.config_parameter"].sudo().get_param("end_service_incentive", default=2)
        default_is_calculated = self.env["ir.config_parameter"].sudo().get_param("is_calculated")
