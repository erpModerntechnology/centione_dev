...
class MergeCustomerWizard(models.TransientModel):
    ...
    journal_id = fields.Many2one(comodel_name="account.journal", string='Payment Method to', required=False, )
...
class MergeCustomerLineWizard(models.TransientModel):
    ...
    journal_id = fields.Many2one('account.journal', string='Payment Method to', required=True,  tracking=True, domain="[('type', 'in', ('bank', 'cash')), ('company_id', '=', company_id)]")
