...
class AccountPayment(models.Model):
    ...
    property_id = fields.Many2one(related="reservation_id.property_id", comodel_name="product.product",string="Unit", required=False, store=True)
    ...
    rent_id = fields.Many2one(comodel_name="res.rent", string="", required=False,readonly=True )
    # property_rent_id = fields.Many2one(related="rent_id.property_id", comodel_name="product.product",string="Unit (Rent)", required=False, store=True)
    property_rent_id = fields.Many2one( comodel_name="product.product",string="Unit (Rent)", required=False, store=True)
    customer_ids = fields.Many2many(comodel_name="res.partner", relation="res_partner_reservation3", column1="par3", column2="reservation3", string="Customers", )
    ...
    #
    #     return res
    # def post_payment(self, date_under_collect=False):
    #     res = super(AccountPayment, self).post_payment()
    #     if self.reservation_id:
    #         if  self.is_payment_lines == True:
    #             self.reservation_id.payment_lines += self.amount
    #
